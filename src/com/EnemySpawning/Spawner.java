    ...
    public void tick() {
        ...
        if (scoreKeep >= 500) {
            ...
            if (game.difficulty == Difficulty.Easy) {
                EasySpawning.spawnEasy(r, game, this, entityHandler);
            } else if (game.difficulty == Difficulty.Normal) {
                NormalSpawning.spawnNormal(r, game, this, entityHandler);
            } else if (game.difficulty == Difficulty.Hard) {
                HardSpawning.spawnHard(r, game, this, entityHandler);
        ...
        entityHandler.clearEnemys(true);
       	...
       	if(game.difficulty == Difficulty.Easy) {
      		...
      		File_io.ChangeLine(GameHandler.saveFilePath, 3, "1: true highScore: " + GameHandler.getScore());
       		...
       		File_io.ChangeLine(GameHandler.saveFilePath, 4, "2: true hghScore: " + GameHandler.getScore());
       	} else if(game.difficulty == Difficulty.FreeMode) {
