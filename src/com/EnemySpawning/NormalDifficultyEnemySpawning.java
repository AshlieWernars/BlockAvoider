...
public class NormalDifficultyEnemySpawning {
	...
	public static void spawnNormal(Random r, Game game, Spawner spawner, EntityHandler entityHandler) {
		...
		case 1:
			...
			break;
		case 4:
			entityHandler.addObject(new LineEnemy(r.nextInt(GameHandler.spawnWidth), r.nextInt(GameHandler.spawnHeight), entityHandler, game, r, true));
			break;
		case 5:
